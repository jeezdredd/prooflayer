...
class Subscription(models.Model):
    ...
    paddle_customer_id = models.CharField(max_length=64, blank=True, db_index=True)
    paddle_subscription_id = models.CharField(max_length=64, blank=True, db_index=True)
