...
from .services import check_known_fake, compute_sha256, extract_metadata, generate_thumbnail
...
def process_submission(self, submission_id):
    ...
    try:
        ...
        submission.save(update_fields=["sha256_hash", "metadata", "thumbnail", "is_known_fake"])
