...
export default function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy" updated="June 15, 2025">
      <section>
        ...
        <ul className="list-disc list-inside space-y-1 text-ink-400">
          ...
          <li><strong className="text-ink-300">Uploaded content:</strong> files submitted for analysis</li>
      ...
      <section>
        ...
        <p>Data is stored on servers in the European Union. Uploaded files are retained for 90 days after submission, then automatically deleted. You can delete your data at any time from account settings.</p>
      </section>
      ...
      <section>
        ...
        <p>You have the right to access, correct, or delete your personal data. Email <a href="mailto:legal@prooflayer.cloud" className="text-iris hover:underline">legal@prooflayer.cloud</a> to exercise these rights. We respond within 30 days.</p>
      </section>
      ...
      <section>
        ...
        <p><a href="mailto:legal@prooflayer.cloud" className="text-iris hover:underline">legal@prooflayer.cloud</a></p>
      </section>
    </LegalLayout>
  );
}
